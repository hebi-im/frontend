...
export default function Hero() {
  ...
  const bannerSlideshowInterval = useRef<ReturnType<typeof setInterval>>(null);
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-0 bottom-0 h-1/4 bg-gradient-to-t from-minsk-900 to-transparent z-30">
        <div className="text-white text-xs absolute left-16 bottom-10 flex flex-col gap-2">
        ...
        {mockMessages.map((message, index) => (
          ...
          >
            ...
            >
              <h1
                className={cn(
                  "text-white text-4xl !font-bold text-right",
